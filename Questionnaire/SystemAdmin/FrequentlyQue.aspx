<%@ Page Title="" Language="C#" MasterPageFile="~/SystemAdmin/Main.Master" AutoEventWireup="true" CodeBehind="FrequentlyQue.aspx.cs" Inherits="Questionnaire.SystemAdmin.FrequentlyQue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <th>種類</th>
            <td>
                <asp:DropDownList ID="dpQue" runat="server">
    ...
    <table border="1">
        <tr>
            <th style="width:40px"></th><th style="width:40px">#</th><th style="width:150px">問題</th><th style="width:70px">種類</th><th></th>
        </tr>
        <asp:Repeater ID="repDown" runat="server">
            <ItemTemplate>
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="FrequentlyQue.aspx?CommID=<%#Eval("QuestionID") %>">編輯</a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
